...
let virtual-env = "E:\YandexDisk\Университет\ChefAI\get_classes_new_venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "E:\YandexDisk\Университет\ChefAI\get_classes_new_venv\Scripts\deactivate.nu"
